                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="stat-value">{{ $jumlahPengajuan }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="stat-value">{{ $pengajuanSelesai }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-lg-8">
            <div class="card content-card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('mahasiswa.pengajuan.index') }}" class="btn btn-sm btn-outline-primary rounded-pill">
                ...
                <div class="card-body p-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless mb-0">
                                <thead class="table-light">
                                    <tr>
                                        <th class="ps-3 py-3" style="font-size: .8rem;">Mentor</th>
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('mahasiswa.cari-mentor') }}" class="btn btn-primary rounded-pill mt-2">
